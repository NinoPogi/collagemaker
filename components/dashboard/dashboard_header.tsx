...
<div className="flex items-center gap-4">
  {projectCount > 0 && (
            <button
              ...
              className="group px-8 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white text-base font-bold rounded-full hover:shadow-2xl hover:scale-105 transition-all duration-300"
            >
